...
public class Server extends Thread{
    ...
    int maxClientsCount, port, maxGamesCount;
    ...
    public void connectClients(){
        try {
            ...
            while(true){
                ...
                System.out.println("no of active games "+activeCount());
                if(receivedObject.getClass() == ClientThread.class){
                    ...
                    for(int i = 0; i < maxGamesCount; i++){
                        if(activeGames[i].gameID == serverClientThread.gameID){
                            activeGames[i].addPlayer(serverClientThread, clientSocket);
                    ...
                    createGame((Game)receivedObject);
    ...
    public void createGame(Game gameObject){
        ...
        for(int i = 0; i < maxGamesCount; i++){
            if(activeGames[i]==null){
                ...
                (activeGames[i] = gameObject).start();
                break;
            }
        }
    }
