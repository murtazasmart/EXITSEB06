package Client.Controllers.MediaControllers;

import Client.Constances.Constance;
...
public class MediaPlayerController {
    ...
    public void btnVolumeClicked(ImageView btnVol)
    {
        ...
        if(volume==true)
        {
            ...
            btnVolume.setImage(new Image("Client/Images/Icons/ButtonIcons/speaker-3.png"));
        ...
        else if(volume==false)
        {
            ...
            btnVolume.setImage(new Image("Client/Images/Icons/ButtonIcons/speaker-2.png"));
